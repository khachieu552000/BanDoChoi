                                ...
                                @if (isset($user))
                                    ...
                                    @foreach ($user as $item)
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="" style="">{{ $item->employee->phone_number}}</td>
                                            <td class="" style="">{{ date('d/m/Y', strtotime($item->employee->birthday)) }}</td>
                                            <td class="" style="">{{ $item->employee->gender}}</td>
                                            <td class="" style="">{{ $item->employee->address}}</td>
                                            <td class="" style="">
